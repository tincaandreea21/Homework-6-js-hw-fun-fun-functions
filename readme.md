...
6. :dart: Commit -m "Question 4 done"
...
3. Is `makeNoise` a function declaration or function expression?
4. Change the syntax for `makeNoise` so that it's a function expression. What happens when you execute the code?
5. What happens if you move `makeNoise()` **after** the function expression?
6. What happens if you `console.log(beep)` below this revised code?
7. Go back to the original code. What happens if you throw a `console.log(beep)` after the function? How is this possible? (This is why we'll be mostly sticking to function expressions.)
8. :dart: Commit -m "Question 5 done"
